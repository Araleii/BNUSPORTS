...
class PingpangController extends Controller {
	...
	public function update($id)
	{
		...
		if(Input::get('changetype')=='lock'){
			if(Input::get('time')=='six2seven'){
				$pingpang->six2seven = 1;
			}else if(Input::get('time')=='seven2eight'){
				$pingpang->seven2eight = 1;
			}else{
				$pingpang->eight2nine = 1;
			}
		}else if(Input::get('changetype')=='unlock'){
			if(Input::get('time')=='six2seven'){
				$pingpang->six2seven = 0;
			}else if(Input::get('time')=='seven2eight'){
				$pingpang->seven2eight = 0;
			}else{
				$pingpang->eight2nine = 0;
			}
		}
