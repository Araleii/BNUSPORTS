  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
        ...
        <a href="{{ URL('activity/activityadmin/create') }}" class="btn btn-lg btn-primary">新增</a>
          @foreach ($activities as $activity)
            ...
            <a href="{{ URL('activity/activityadmin/'.$activity->id.'/edit') }}" class="btn btn-success">编辑</a>

            <form action="{{ URL('activity/activityadmin/'.$activity->id) }}" method="POST" style="display: inline;">
